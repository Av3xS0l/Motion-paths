...
class GeneratePath(object):
    ...
    def __init__(self, id: int):
        ...
        while sucsess:
            try:
                ...
                self.save_png(f'./outputs/many/base{id}.png', self.system, 10)
    ...
    def create_system(self, bl_1=60, bj_1=30, bl_2=30, x_1=-10, y_1=-20, r_1=5, s_1=1, i_1=0, x_2=10, y_2=-20, r_2=6, s_2=2, i_2=180) -> list:
        i_1 = self.id
        # Defaults:
...
if __name__ == '__main__':
    main = [GeneratePath(x) for x in np.arange(0, 360, 2)]
